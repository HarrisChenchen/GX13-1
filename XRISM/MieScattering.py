...
import constant_helper as helpers
import numpy as np
...
def calculate(lam, a, cm, theta=0.0, memlim=MAX_RAM):
    """
    ...
    lam_cm0, a_cm0, theta_rad0 = _store_parameters(lam, a, cm, theta)
    ...
    qback = qback
    gsca  = gsca
    diff  = Cdiff # ster^-1,  NE x NA x NTH
...
def _store_parameters(lam, a, cm, theta):
    """
